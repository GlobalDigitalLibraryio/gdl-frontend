      ...
      <>
        ...
        >
          {showCanonicalChapterUrl && (
            <link
              rel="canonical"
              href={`${canonicalUrl}/${book.language.code}/books/embed/${
                book.id
              }/${current.id}`}
            />
          )}
          {prev && (
            <link
              rel="prev"
              href={`/${book.language.code}/books/embed/${book.id}/${prev.id}`}
            />
          )}
          {next && (
            <link
              rel="next"
              href={`/${book.language.code}/books/embed/${book.id}/${next.id}`}
            />
          )}
        </Head>
...
export default withErrorPage(withApollo(Embed));
